...
import org.apache.cassandra.tools.BulkLoader.LoaderOptions;
...
public class CustomBulkLoader {
    ...
    public static void load(LoaderOptions options) throws ExecutionException, InterruptedException {
